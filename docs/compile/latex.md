...
files — no TeX distribution (TeX Live, MiKTeX, etc.) required. It parses LaTeX
into an internal AST, renders it to HTML, typesets the math with
[MathJax](https://www.mathjax.org/), and prints the result to PDF.
