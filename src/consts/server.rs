        ...
        (function(){
            ...
            CodeMirror.defineSimpleMode('scimon',{
                start:[
                    ...
                    {regex:/\b(group|for|in|import|path|open|compress|copy|covers|qrcode|style|print|readme|math|merge|split|rotate|watermark|convert|server|as|image)\b/,token:'keyword'},
