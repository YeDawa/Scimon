        ...
        (function(){
            ...
            CodeMirror.defineSimpleMode('scimon',{
                start:[
                    ...
                    {regex:/\b(group|for|in|import|include|path|open|compress|copy|covers|qrcode|style|print|readme|math|merge|split|rotate|convert|server|as)\b/,token:'keyword'},
